# 🎬 Movie Recommender – Matrix Factorization Baseline

## Overview

This module implements a **collaborative filtering recommender system** based on Matrix Factorization.

It learns user and movie representations (“embeddings”) from historical rating data and uses them to generate movie recommendations.
...
- Each **movie** is represented as a vector in a learned “preference space”.
...
| rating     | float   | explicit rating (e.g., 0.5–5.0) |
...
- Add explainability (“Because you liked…”)
